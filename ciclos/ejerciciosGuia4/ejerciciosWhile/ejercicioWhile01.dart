...
//PROCESO
  while (contador < cantVendedores) { //controla vendedores
    for (int i = 0; i < cantVenta; i++) { //controla ventas
      print("indique el valor de la venta ${i+1}del vendedor ${contador+1}");
      valorVenta = double.parse(stdin.readLineSync()!);
      totalVenta += valorVenta;
      while(valorVenta<0 || valorVenta>10000000); //controla el rango valido
